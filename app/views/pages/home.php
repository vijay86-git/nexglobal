					...
					<div class="row">
						<div class="col-md-4">
							<div class="banner-content">
								<h2 class="">Tech Agency...</h2>
								<div class="home-services">
									<ul>
										<li>apps <i class="entypo-dot hidden-xs"></i></li>
										<li>web <i class="entypo-dot hidden-xs"></i></li>
										<li>digital <i class="entypo-dot hidden-xs"></i></li>
										<li>design</li>
									</ul>
								</div>
		...
		<section class="our-work">
			<div class="container">
				...
				<p>5000+ awesome projects delivered in 50+ nations earned us the respect we proudly cherish today.</p>
